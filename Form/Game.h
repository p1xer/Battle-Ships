...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(4, 170);
			...
			this->groupBox1->Location = System::Drawing::Point(250, 220);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(256, 191);
			...
			// answers
			// 
			this->answers->HeaderText = L"Быки";
			this->answers->Name = L"answers";
			this->answers->Width = 50;
			// 
			// answers2
			// 
			this->answers2->HeaderText = L"Коровы";
			...
			this->dataGridView3->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(10) {
				this->Team1_1,
					this->Team1_2, this->Team1_3, this->Team1_4, this->Team1_5, this->Team1_6, this->Team1_7, this->Team1_8, this->Team1_9, this->Team1_10
			});
			this->dataGridView3->Location = System::Drawing::Point(894, 79);
			this->dataGridView3->Name = L"dataGridView3";
			this->dataGridView3->Size = System::Drawing::Size(291, 147);
			...
			this->ClientSize = System::Drawing::Size(1338, 702);
...
void GameRand()
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		//Додати перевирку щоб не повторювалось
	}
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//int r1 = color->R;
	//class GameArea; // матриця 10 на 10. Позначити можливi стани(певний диапазон значень). режим налаштування(корабли, мини, правила)
	//class Player; // Метод генерации.Им'я, логин, пароль, таблиця досянень
}
};
}
